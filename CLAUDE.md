...
- **Búsqueda web real activada** (`options.webSearch: true`, nativo del nodo Anthropic — no hace falta nodo AI Agent ni Tool aparte) en los 3 pasos que necesitan datos reales de internet: `1 - Conciencia de Mercado`, `2 - Competidores` y `3 - Psicografia RMBC` (citas textuales reales, marcas/creadores reales, tendencias reales). Los pasos 4, 5 y 6 son de síntesis sobre lo ya investigado y no la necesitan.
